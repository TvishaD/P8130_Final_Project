...
```{r table for variable description in appendix}
#BEST WAY MIGHT BE JUST TO MAKE ONE IN MICROSOFT WORD MANUALLY AGH.

Variable = c("id", "body_density", "age", "weight", "height", "neck", "chest", "abdomen",
             "hip", "thigh", "knee", "ankle", "bicep", "forearm", "wrist")

Description = c("Case number: 1-252", "Body density (gm/cm3)", "Age (in years)", "Weight (in lbs",
                "Height (in inches)", "Circumference of Neck (in cm)", "Circumference of Chest (in cm)",
                "Circumference of Abdomen (in cm) - measured “at the umbilicus and level with the iliac crest”",
                "Circumference of Hip (in cm)", "Circumference of Thigh (in cm)", "Circumference of Knee (in cm)",
                "Circumference of Ankle (in cm)", "Extended bicep circumference (in cm)", 
                "Circumference of forearm (in cm)", 
                "Circumference of Wrist (in cm) - – measured “distal to the styloid processes”")
